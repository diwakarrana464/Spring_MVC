...
import com.rana.command.PersonCommand;
import com.rana.validator.PersonCommandValidator;
...
public class PersonProfileController {
	...
	@GetMapping("/register.htm")// for initial phase request
	public String showForm(		
			@ModelAttribute("perCmd")
			PersonCommand cmd
			) {
